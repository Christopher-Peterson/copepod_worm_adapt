...
### Datasets
There are 3 datasets in here: "chapter2.copepods.cleaned.Aug2020.csv", "chapter2.copepods.cleaned.csv", and "chapter_2_copepod_for_bayes.csv."
They are identical except that the Aug2020 one had a few extra space/tabs for a few individuals in the numb.worm column added by mistake during data collection. The "for_bayes" version of the dataset was modified from the Aug2020 version by a script in the repository, and is the one used in the actual analysis.   
